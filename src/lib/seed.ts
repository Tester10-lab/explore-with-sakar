      ...
      columns: [
        {
          ...
          links: [
            ...
            { id: 'fl-3', label: 'Go Deeper', url: '/experiences/go-deeper', visible: true, order: 1 },
            { id: 'fl-5', label: 'Custom Private Journeys', url: '/experiences/custom-journeys', visible: true, order: 2 },
            { id: 'fl-6', label: 'All Curated Experiences →', url: '/experiences', visible: true, order: 3 },
          ],
        },
        {
          id: 'footer-explore',
