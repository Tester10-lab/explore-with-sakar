          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs px-2.5 py-0.5 rounded-full bg-slate-100 font-mono font-bold text-slate-800 border border-slate-200">
                    {topics.length} Topics
                  </span>
                </div>
                <p className="text-xs text-slate-700 font-normal mt-1 max-w-2xl leading-relaxed">
                  {experienceDescription}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 shrink-0">
              <Link
                href={publicUrl}
                target="_blank"
                className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-white border border-slate-300 text-xs font-semibold text-slate-800 hover:bg-slate-50 transition-colors shadow-sm"
              >
                      ...
                      <div className="flex items-start gap-4 min-w-0">
                        ...
                        <div className="min-w-0 space-y-1">
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            {topic.duration && (
                              <span className="text-[11px] text-slate-700 flex items-center gap-1 font-mono font-medium">
                          ...
                          <p className="text-xs text-slate-700 font-normal line-clamp-2 max-w-xl leading-relaxed">
                            {topic.shortDescription || 'No description provided.'}
                          </p>

                          {keyQuote?.quote && (
                            <p className="text-[11px] italic text-slate-700 font-medium line-clamp-1 border-l-2 border-terracotta pl-2">
