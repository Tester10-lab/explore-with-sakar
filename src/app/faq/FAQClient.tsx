...
interface FAQClientProps {
  initialFaq: CmsFaqItem[];
}

export default function FAQClient({ initialFaq }: FAQClientProps) {
  ...
  }, [activeCategory, searchQuery, initialFaq]);
        ...
        <div className="editorial-container max-w-4xl mx-auto">
          {filteredItems.length > 0 ? (
            <div className="space-y-6">
              ...
              <FAQAccordion items={filteredItems as any} />
            </div>
          ) : (
