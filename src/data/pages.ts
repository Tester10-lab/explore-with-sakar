...
export const DEFAULT_PUBLIC_PAGES: PageContent[] = [
  ...
  // --- EXPERIENCES (PUBLIC NAVBAR DROPDOWN) ---
  {
    ...
    seo: {
      ...
      canonicalUrl: 'https://explorewithsakar.com/services/beyond-the-map',
      sitemapVisible: true,
    },
    sections: [
      ...
      { id: 'sec-btm-chapters', type: 'chapters-grid', label: 'The 4 Distinct Journeys (Living Courtyards, Echoes in Stone, Artisan Path, Sacred Geometry)', visible: true, order: 2, content: {} },
  ...
  },
  {
    ...
    name: 'Go Within',
    url: '/services/spiritual-wellness',
    status: 'published',
    seo: {
      ...
      canonicalUrl: 'https://explorewithsakar.com/services/spiritual-wellness',
      sitemapVisible: true,
    },
    sections: [
  ...
  },
  {
    ...
    seo: {
      ...
      canonicalUrl: 'https://explorewithsakar.com/services/homestays',
      sitemapVisible: true,
    },
    sections: [
  ...
  },
  {
    ...
    sections: [
      { id: 'sec-lam-hero', type: 'hero', label: 'Page Hero Header', visible: true, order: 0, content: { title: 'Leave a Mark', subtitle: 'Responsible Community Projects & Ethical Mountain Giving' } },
      { id: 'sec-lam-initiatives', type: 'features-grid', label: 'Community Projects & School Programs', visible: true, order: 1, content: {} },
      { id: 'sec-lam-conservation', type: 'narrative', label: 'Environmental & Habitat Stewardship', visible: true, order: 2, content: {} },
      { id: 'sec-lam-cta', type: 'cta', label: 'Get Involved with Sakar CTA', visible: true, order: 3, content: {} },
    ],
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  ...
  },
  {
    ...
    seo: {
      ...
      canonicalUrl: 'https://explorewithsakar.com/services/custom-journeys',
      sitemapVisible: true,
    },
    sections: [
